        ...
        function __construct($token, $group_id, $sub, $like, $com, $api, $img, $output, $font) {
            ...
            if($this->config['sub']['active']) {
                $this->config['sub'] += [
                    ...
                    'title_pixel_x' => 1475,             // Координаты Заголовка по оси X
                    'title_pixel_y' => 330,             // Координаты Заголовка по оси Y

                    'p_pixel_x' => 1500,              // Координаты аватарки по оси Х
                    'p_pixel_y' => 348,             // Координаты аватарки по оси Y

                    't_pixel_x' => 1550,             // Координаты имени и фамилии по оси Х
                    't_pixel_y' => 485,             // Координаты имени и фамилии по оси Y
                ];
            }
